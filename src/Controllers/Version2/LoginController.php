...
namespace Dorbitt\Controllers\Version2;
...
class LoginController extends ResourceController
{
    ...
    public function findSuccess()
    {
        ...
        $text = 'v2/auth/phone_number/login_password?n=' . $phone_number_encrypt;
        return redirect()->to($text);
        // return $text;
    ...
    public function login_password()
    {
        ...
        if (!$phone_number) {
            return redirect()->to('v2/auth/phone_number'); 
        }
        return view($this->vH->ummuView("pages/v2/auth/form_login_withPassword"));
    }
    ...
    {
        return view($this->vH->ummuView("pages/v2/auth/form_login_withOTP"));
    }
    ...
    public function create_otpSuccess()
    {
        ...
        $text = 'v2/auth/phone_number/login_otp?n=' . $phone_number_encrypt;
        return redirect()->to($text);
    }
    ...
    public function logout()
    {
        ...
        if ($login_module == 'iescm') {
            return redirect()->to('/v2/auth/login/phone');
        } else if ($login_module == 'mcp') {
            return redirect()->to('/v2/auth/login_mcp');
        } else {
            return redirect()->to('/v2/auth');
        }
    }
