...
class BargeController extends ResourceController
{
    public function __construct()
    {
        $this->dir_view = 'pages/ms_barge/';
    ...
    {
        $data = [
            'page_title' => 'Master Data Barge',
            'module_kode' => 'ms_barge',
            'navlink' => 'ms_barge',
            'group' => ['masterdata'],
            'tmp' => $this->gHelp->tmp(),
    ...
    public function show($id = null)
    {
        ...
        $params = [
            "path"      => "api/ms_barge/show",
            "method" => 'GET',
            "payload" => $payload,
            "headers" => $this->cH->headers3('ms_barge')
        ];
