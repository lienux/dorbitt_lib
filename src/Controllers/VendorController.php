...
class VendorController extends ResourceController
{
    public function __construct()
    {
        ...
        $this->module_kode2 = 'vendor_verification';
        $this->dir_view = 'pages/freight_charter/';
        $this->dir_view2 = 'pages/vendor_verification/';
    ...
    public function index()
    {
        ...
        return view($this->vH->ummuView($this->dir_view2 . 'index'), $data);
    }
    ...
    public function index_verification()
    {
        $data = [
            ...
            'module_kode' => $this->module_kode2,
            'navlink' => $this->module_kode2,
            'group' => ['purchasing'],
            'tmp' => $this->gHelp->tmp(),
    ...
    public function show_calon_vendor()
    {
        //
    }
