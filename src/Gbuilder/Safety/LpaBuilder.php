...
class LpaBuilder
{
    ...
    private function qbAlya()
    {
        ...
        $subquery = $this->iescm->table($table . ' a')
            ...
            // ->join('dorbitt_she.lokasi_temuan d', 'd.id = a.lokasi_temuan_id', 'left')
            // ->join('dorbitt_she.jenis_bahaya e', 'e.id = a.jenis_temuan_id', 'left')
            // ->join('dorbitt_she.kode_bahaya f', 'f.id = a.kode_bahaya_id', 'left')
            // ->join('dorbitt.document_kode g', 'g.document_id = 5', 'left')
            // ->join('dorbitt_gallery.photos h', 'h.id = a.foto_temuan_id', 'left')
            // ->join('dorbitt_gallery.photos i', 'i.id = a.foto_perbaikan_id', 'left')
