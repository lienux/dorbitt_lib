...
<body>
    <div class="container-fluid" id="grad1">
        <div class="col-xl-6 py-4" style="margin-left: auto; margin-right: auto;">
            <!-- COVER -->
            <div class="card mb-2 rounded border rounded-top">
                <div class="card-body p-0">
                    <img src="<?= base_url() ?>recruitment_close.jpg" class="img-fluid" alt="...">
                </div>
            </div>
    ...
    <script
        src="<?= getenv('dorbitt.cdn') ?>ummu-lib/<?= (getenv('CI_ENVIRONMENT') == 'production') ? 'ummu.min.js' : 'ummu.js' ?>"></script>
    <script src="<?= base_url() ?>Gasset/js/ummu.js"></script>
