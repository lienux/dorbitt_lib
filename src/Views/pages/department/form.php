        ...
        <div class="row">
            <div class="col-lg-6 col-sm-12 mb-2">
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="kode" id="kode" class="form-control form-control-sm" disabled>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="name" id="name" class="form-control form-control-sm endis" data-label="Department Name" required disabled>
                    </div>
                </div>
            </div>
