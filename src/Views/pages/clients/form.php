<div class="mt-2">
    ...
    <div class="row mb-2" id="classic_button">
    ...
    <form id="form_input" method="post" accept-charset="utf-8" enctype="multipart/form-data" novalidate> 
        <div class="row">
            <div class="col">
                <div class="row mb-2">
                ...
                <!-- <div class="row mb-2">
                    <label class="col-sm-3 col-form-label">Username<span class="text-danger small"> *</span></label>
                    <div class="col-sm-9">
                        <input type="text" id="username" class="form-control form-control-sm" required disabled>
                    </div>
                </div>
                <div class="row mb-2">
