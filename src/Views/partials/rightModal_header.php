<div class="modal fade modal-right" id="rightModal2" tabindex="-1" data-bs-backdrop="static">
        ...
        <div class="modal-content bg-light">
            ...
            <div class="modal-body">
                <div class="table-responsive">
                    <!-- <table class="table table-sm table-striped table-bordered text-sm text-nowrap" id="dataTable" width="100%"
                        cellspacing="0">
                    </table>
                </div>
            </div>
