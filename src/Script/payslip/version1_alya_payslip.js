var app = {
    ...
    config: {
        autoload: function () {
            ...
            $("#search_payslip").on("click", function () {
                ...
                if (select_payslip_periode == "undefined" || select_payslip_periode == "" || select_payslip_periode == null) {
            ...
            $("#create_payslip_topdf").on("click", function () {
                ...
                if (select_payslip_periode == "undefined" || select_payslip_periode == "" || select_payslip_periode == null) {
                    ...
                    if ($ummu.vars.hcm.payroll.payslip.pdf.periode_id == select_payslip_periode) {
                        $("#pdf_payslip embed").prop("src",$ummu.vars.hcm.payroll.payslip.pdf.url);
                        $("#loader_download, #card_slip").addClass("collapse");
                        $("#pdf_payslip").removeClass("collapse");
                    } else {
                        $("#loader_download").removeClass("collapse");

                        const url = `${globalVar.url_create_pdf}?periode_id=${select_payslip_periode}&otp=${otp}`;
                        console.log(url)
                        ...
                        ummu.done(function (result) {
                            ...
                            if (response.status == true) {
                                ...
                                $ummu.vars.hcm.payroll.payslip.pdf.periode_id = $("#select_payslip_periode").val();
    ...
    controllers: {
        show: function () {
            // var select_payslip_periode = $("#select_payslip_periode").val();
            // if ($ummu.vars.hcm.payroll.payslip.show.periode_id == select_payslip_periode) {
    ...
    views: {
        ...
        set_row_to_form: function (row) {
            ...
            var insentif_produksi = $ummu.helpers.currency.us(row.insentif_produksi);
            var insentif_kehadiran = $ummu.helpers.currency.us(row.insentif_kehadiran);
            ...
            var potongan_jamsostek_jht = $ummu.helpers.currency.us(row.potongan_jamsostek_jht);
            var potongan_jamsostek_jp = $ummu.helpers.currency.us(row.potongan_jamsostek_jp);
    ...
    func: {
        ...
        tunjangan: function (insentif_produksi,insentif_kehadiran,tj_kesetaraan,tj_acting) {
            if (insentif_produksi == 0 ||insentif_produksi == null ||insentif_produksi == "" ||insentif_produksi == "0,00" ||insentif_produksi == "0.00") {
                ...
                $("#insentif_produksi_value").html("<span>" + insentif_produksi + "</span>");
            }

            if (insentif_kehadiran == 0 ||insentif_kehadiran == null ||insentif_kehadiran == "" ||insentif_kehadiran == "0,00" ||insentif_kehadiran == "0.00") {
                ...
                $("#insentif_kehadiran_value").html("<span>" + insentif_kehadiran + "</span>");
            }

            if (tj_kesetaraan == 0 ||tj_kesetaraan == null ||tj_kesetaraan == "" ||tj_kesetaraan == "0,00" ||tj_kesetaraan == "0.00") {
            ...
            if (tj_acting == 0 ||tj_acting == null ||tj_acting == "" ||tj_acting == "0,00" ||tj_acting == "0.00") {
        ...
        potongan: function (potongan_jamsostek_jht,potongan_jamsostek_jp,potongan_kasbon,potongan_tiket) {
            if (potongan_jamsostek_jht == 0 || potongan_jamsostek_jht == null || potongan_jamsostek_jht == "" || potongan_jamsostek_jht == "0,00" || potongan_jamsostek_jht == "0.00") {
                ...
                $("#potongan_jamsostek_jht_value").html("<span>" + potongan_jamsostek_jht + "</span>");
            }

            if ( potongan_jamsostek_jp == 0 || potongan_jamsostek_jp == null || potongan_jamsostek_jp == "" || potongan_jamsostek_jp == "0,00" || potongan_jamsostek_jp == "0.00") {
                ...
                $("#potongan_jamsostek_jp_value").html("<span>" + potongan_jamsostek_jp + "</span>");
            }

            if (potongan_kasbon == 0 || potongan_kasbon == null || potongan_kasbon == "" || potongan_kasbon == "0,00" || potongan_kasbon == "0.00") {
                ...
                $("#potongan_kasbon_value").html("<span>" + potongan_kasbon + "</span>");
            }

            if (potongan_tiket == 0 || potongan_tiket == null || potongan_tiket == "" || potongan_tiket == "0,00" || potongan_tiket == "0.00") {
